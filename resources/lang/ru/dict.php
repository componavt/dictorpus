...
return [
    ...
    */
    ...
    'label_can_not_be_removed' => 'Помету нельзя удалять, есть связанные с ней леммы',
    ...
    'relevance_scope_for_select' => [
        10 => '<span class="relevance-10">лучший пример</span>',
        7 => 'отличный пример',
        5 => 'хороший пример',
        3 => 'плохой пример',
        1 => 'не проверено',
    ...
    'save_and_continue' => 'Сохранить и продолжить проверку',
    'save_and_return_to_show' => 'Сохранить и вернуться к просмотру',
    ...
    'show_checked' => 'Выводить проверенные примеры',
    'show_dialectal' => 'показать диалектные варианты',
    'speaker' => 'Диктор',
    'status' => 'статус',
    ...
    'unsaved_examples_confirm' => 'Есть несохранённые изменения оценок. При переходе они будут потеряны. Продолжить?',
];
