...
return [
    ...
    */
    ...
    'add_publication' => 'Добавить публикацию',
    'add_pubpart' => 'Добавить часть публикации',
    ...
    'bible' => 'Библия',
    'bible_has_text' => 'Книга ":name" не может быть удален, существуют тексты связанные с ней',
    'bible_link' => 'библейская ссылка',
    'bible_links' => 'библейские ссылки',
    'bible_list' => 'Список книг',
    'bible_parallel_passages' => 'Параллельные места',
    'bible_reference_type' => 'Тип ссылки',
    'bible_reference_types' => [
        1 => 'Основной библейский текст',
        2 => 'Параллельное место',
    ],
    'bible_removed' => 'Книга ":name" удалена.',
    ...
    'celebration_type' => 'Привязать к карте праздников',
    'celebration_types' => [
        1 => 'по месту рождения информанта',
        2 => 'по месту записи',
        3 => 'по упомянутому поселению',
    ],
    'chapter' => 'Глава',
    ...
    'is_periodic' => 'Периодичное издание?',
    ...
    'mentioned_district' => 'упомянутый район',
    'mentioned_place' => 'упомянутый населенный пункт',
    'mentioned_region' => 'упомянутая республика, область',
    ...
    'of_plot' => 'сюжета / персонажа',
    'of_publication' => 'публикации',
    ...
    'only_checked' => 'только проверенные экспертом результаты',
    ...
    'plot' => 'сюжет / персонаж',
    'plot_has_text' => 'Сюжет / персонаж ":name" не может быть удален, существуют тексты связанные с ним',
    'plot_list' => 'Список сюжетов / персонажей',
    'plot_removed' => 'Сюжет / персонаж ":name" удален.',

    'pubparts' => 'Части публикации',
    'publication' => 'Публикация',
    'publication_has_texts' => 'Публикация ":name" не может быть удалена, существуют тексты связанные с ней',
    'publication_removed' => 'Публикация ":name" удалена.',
    ...
    'rutube_id' => 'Код видео на RuTube',

    'sections' => 'Разделы / главы',
    'select_corpus' => 'Выберите корпус',
    'sentences' => 'Предложения',
    'show_gram_markup' => 'Показать грамматическую разметку',
