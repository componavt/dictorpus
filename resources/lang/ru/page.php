...
return [
    ...
    */
    ...
    'permission' => '<p style="text-align: right; position: absolute; top: 36px; right: 4%"><a class="btn btn-primary btn-default" href="/docs/permissions/permission_form.doc">бланк разрешения</a></p>'
                  ...
                  . 'на вепсском языке для использования в проекте ВепКар (10.02.2018).</p>'
                  ...
                  . ' в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/myznikov.pdf">от С.А. Мызникова</a> на использование текстов в книге '
                  . '"Русско-вепсские заговоры Олонецкого сборника" в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/toporkov.pdf">от А.Л. Топоркова</a> на использование текстов в книге '
                  . '"Русские заговоры из рукописных источников XVII - первой половины XIX в." в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/images/permissions/gromova_aiga.jpg">от Л.Г. Громовой</a> на использование текстов в учебном пособии '
                  . 'для чтения и говорения на карельском языке (тверской говор) "Aiga lugie i paissa karielakši" в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/images/permissions/gromova_sana.jpg">от Л.Г. Громовой</a> на использование материалов '
                  . 'газеты Karielan šana "Карельское слово" в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/images/permissions/turichev.jpg">от Н.А. Туричева</a> на использование текста книги "Armaš šana" '
                  . ' в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/periodica2025.pdf">издательства "Периодика"</a> на использование материалов '
                  . 'карельской газеты "Oma Mua", вепсской газеты "Kodima", альманаха "Taival"  на карельском языке и альманаха "Verez tullei" '
                  . 'на вепсском языке и мультиязычного портала "OmaMedia" для использования в проекте ВепКар (10.02.2025).</p>'
                  . '<p>Разрешение <a href="/images/permissions/libertsova.jpg">от Н.А. Туричева</a> на использование произведения "25 причин, почему нужно читать газету «Oma Mua»" '
                  . ' в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/images/permissions/sinitskaya.jpg">от Н.А. Туричева</a> на использование произведения "In`aine" '
                  . ' в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/kondrateva2025.pdf">от В.М. Кондратьевой</a> на использование произведений '
                  . ' в проекте ВепКар.</p>'
                  . '<p>Разрешение издательства "Периодика" на использование материалов на вепсском и карельском языках из '
                  ...
                  . '<p>Разрешение <a href="/docs/permissions/gapeeva.pdf">от А.Н. Гапеевой</a> на использование текстов '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/libertsova.pdf">от В.В. Либерцовой</a> на использование статей, опубликованных в газете "Oma Mua" '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/nikitina.pdf">от Л.Н. Никитиной</a> на использование рассказов, опубликованных в газете "Oma Mua" '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/michurova.pdf">от Н.В. Мичуровой</a> на использование переводов рассказов С.И. Евстафьева '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/usova.pdf">от А.В. Усовой</a> на использование переводов рассказов С.И. Евстафьева '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/lazarev.pdf">от И.И. Лазарева</a> на использование рассказов, опубликованных в газете "Oma Mua" '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/evstafeev.pdf">от С.И. Евстафеева</a> на использование рассказов, опубликованных в газете "Oma Mua" и альманахе "Тайвал" '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/baltazar.pdf">от Л.И. Балтазар</a> на использование статей, опубликованных в газете "Oma Mua" '
                  . 'в проекте ВепКар.</p>'
                  . '<p>Разрешение <a href="/docs/permissions/karpin.pdf">от Н.И. Карпина</a> на использование рассказов, опубликованных в газете "Oma Mua" '
                  . 'в проекте ВепКар.</p>'
