...
return [
    ...
    */
    ...
    'welcome_text' =>  '<p>Welcome to VepKar — the Open corpus of Veps and Karelian languages 
                        ...
                        <p>The name of the project "Dictorpus" indicates the union of the dictionary (DICTionary) 
                        and the corpus (cORPUS). The program Dictorpus is designed for teams of linguists working with the languages​ of the world. 
                        At the moment, the program supports and takes into account the features of Veps and Karelian languages.</p>
