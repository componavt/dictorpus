...
@section('body')
    ...
    <h3><a href="{{ route('collection.9.pointer') }}">Указатель основных сюжетов и мотивов/тем карельских мифологических рассказов (быличек). Часть 1. Мифологические существа, связанные с праздниками</a></h3>
@stop
