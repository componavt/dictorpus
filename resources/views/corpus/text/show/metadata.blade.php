<div class="text-metadata">
    ...
    @if ($text->biblicalPassageToString())
    <p>
        <b>{{ trans('corpus.biblical_passage') }}:</b>
        {{ $text->biblicalPassageToString() }}
    </p>
    @endif

    @if ($text->parallelPassagesToString())
    <p>
        <b>{{ trans('corpus.parallel_passages') }}:</b>
        {{ $text->parallelPassagesToString() }}
    </p>
    @endif
</div>      
