                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown" id='menu4'>
                        ...
                        <ul class="dropdown-menu" role="menu" id='menu4-sub'>
                            ...
                            <li><a href="{{ LaravelLocalization::localizeURL('/page/references_genre') }}">{{ trans('navigation.references_genre') }}</a></li>
                            <li><a href="{{ LaravelLocalization::localizeURL('/page/references_geo') }}">{{ trans('navigation.references_geo') }}</a></li>
                            ...
                            <li><a href="{{ LaravelLocalization::localizeURL('/page/references_gram') }}">{{ trans('navigation.references_gram') }}</a></li>
