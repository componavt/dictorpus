...
<div class="container">
    ...
    <p>
        ...
        (с уже существующим English), из которых можно взять перевод.<br><br>

        Можно предварительно запустить команду<br>
        php artisan vepkar:backfill-safe-meaning-en --dry-run (App\Console\Commands\BackfillSafeMeaningEn)<br>
        и автоматически проставить словам английские переводы от подобных слов с одинаковым переводом.<br>
        А для слов с несколькими вариантами перевода воспользоваться этой формой.
    </p>
