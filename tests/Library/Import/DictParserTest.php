...
class DictParserTest extends TestCase
{
    ...
    public function testParseEntry_2lemma_1meaning_7bases()
    {
        ...
        $expected = [
            ...
            "meanings" =>
            [1 => [
                'ru' => "обветрить, высушить ветром (пашню и пр.)",
    ...
    public function testParseEntry_1lemma_2meanings_7bases()
    {
        ...
        $expected = [
            ...
            [
                1 => [
                    'ru' => "подвинуться, отодвинуться; переместиться",
                    // 'fi'=>"siirtyä"
                ],
                2 => [
                    'ru' => "двигаться, проходить (о времени, действии)",
                    //'fi'=>"siirtyä"
                ]
            ]
        ];
    ...
    public function testParseEntry_1lemma_2meanings_5bases_def()
    {
        ...
        $expected = [
            ...
            [
                1 => [
                    'ru' => "открываться, раскрываться; распускаться",
                    // 'fi'=>"avautua"
                ],
                2 => [
                    'ru' => "освобождаться (ото льда и т.д.)",
                    //'fi'=>"avautua"
                ]
            ]
        ];
