...
trait MonumentSearch
{
    ...
    public static function urlArgs($request)
    {
        $url_args = Str::urlArgs($request) + [
            ...
            'search_is_printed'     => (string)$request->input('search_is_printed'),
    ...
    public static function search(array $url_args)
    {
        ...
        $objs = self::orderBy('publ_date_from')->orderBy('publ_date_to');
        ...
        if ($url_args['search_is_printed'] != '') {
            $objs->where('is_printed', $url_args['search_is_printed']);
        }
        return $objs;
    }
