...
class LemmaFeature extends Model
{
    ...
    protected $fillable = ['id','animacy','abbr','number','reflexive','impersonal', 'without_gram',
        'transitive','prontype_id','numtype_id','degree_id','advtype_id', 'comptype_id', 'partype_id', 'descriptive'];
    public $featuresByPOS = [1  => ['degree_id', 'number', 'without_gram'],                   // adjective
                             ...
                             11 => ['reflexive', 'transitive', 'descriptive', 'impersonal', 'without_gram'],     // verb                             
                             14 => ['animacy', 'abbr', 'number', 'without_gram'], // proper noun
                             19 => ['comptype_id'], // phrases
                             21 => ['partype_id'], // participles
                            ];
...
//dd($lemma_feature->isAllowFeature('comptype_id'));            
            if (isset($features[$field]) && ($field == 'phonetics' || $lemma_feature->isAllowFeature($field))) {
