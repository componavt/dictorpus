...
Route::group(
        ...
        function () {
                ...
                Route::resource(
                        'informant',
                        'Corpus\InformantController',
                        ['names' => [
                                'update' => 'informant.update',
                ...
                Route::resource(
                        'monument',
                        'Corpus\MonumentController',
                        ['names' => [
                                'update' => 'monument.update',
                ...
                Route::resource(
                        'motive',
                        'Corpus\MotiveController',
                        ['names' => [
                                'update' => 'motive.update',
                                'store' => 'motive.store',
                ...
                Route::resource(
                        'motype',
                        'Corpus\MotypeController',
                        ['names' => [
                                'update' => 'motype.update',
                                'store' => 'motype.store',
                ...
                Route::resource(
                        'sentence',
                        'Corpus\SentenceController',
                        ['names' => [
                                'update' => 'sentence.update',
