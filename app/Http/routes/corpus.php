...
Route::group(
    ...
    function () {
        ...
        Route::get('collection/{id}/texts', 'Corpus\CollectionController@texts');
        ...
        Route::get('collection/9/pointer', 'Corpus\CollectionController@pointerFor9')->name('collection.9.pointer');
        ...
        Route::get('publication/{id}/info', 'Corpus\PublicationController@info');
        ...
        Route::resource('genre', 'Corpus\GenreController', route_names('genre'));
        Route::resource('informant', 'Corpus\InformantController', route_names('informant'));
        Route::resource('monument', 'Corpus\MonumentController', route_names('monument'));
        Route::resource('motive', 'Corpus\MotiveController', route_names('motive'));
        Route::resource('motype', 'Corpus\MotypeController', route_names('motype'));
        Route::resource('place', 'Corpus\PlaceController', route_names('place'));
        Route::resource('plot', 'Corpus\PlotController', route_names('plot'));
        Route::resource('publication', 'Corpus\PublicationController', route_names('publication'));
        Route::resource('recorder', 'Corpus\RecorderController', route_names('recorder'));
        Route::resource('region', 'Corpus\RegionController', route_names('region'));
        Route::resource('sentence', 'Corpus\SentenceController', route_names('sentence'));
        Route::resource('source', 'Corpus\SourceController', route_names('source'));
        Route::resource('text', 'Corpus\TextController', route_names('text'));
        Route::resource('topic', 'Corpus\TopicController', route_names('topic'));
    }
);
