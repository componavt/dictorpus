...
Route::group(
        ...
        function () {
                ...
                Route::get('meaning/full_new_list', 'Dict\MeaningController@fullNewList');
                ...
                Route::resource(
                        'concept_category',
                        'Dict\ConceptCategoryController',
                        ['names' => [
                                'update' => 'concept_category.update',
                ...
                Route::resource(
                        'gramset',
                        'Dict\GramsetController',
                        ['names' => [
                                'update' => 'gramset.update',
                                'store' => 'gramset.store',
                ...
                Route::resource(
                        'gramset_category',
                        'Dict\GramsetCategoryController',
                        ['names' => [
                                'update' => 'gramset_category.update',
                ...
                Route::resource(
                        'synset',
                        'Dict\SynsetController',
                        ['names' => [
                                'update' => 'synset.update',
                                'store' => 'synset.store',
                ...
                Route::resource(
                        'syntype',
                        'Dict\SyntypeController',
                        ['names' => [
                                'update' => 'syntype.update',
                                'store' => 'syntype.store',
