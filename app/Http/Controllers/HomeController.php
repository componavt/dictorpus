...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $lemmas_choice = trans_choice('blob.choice_articles', $total_lemmas, [], $locale);
        $texts_choice = trans_choice('blob.choice_texts', $total_texts, [], $locale);
        $words_choice = trans_choice('blob.choice_words', $total_words, [], $locale);
