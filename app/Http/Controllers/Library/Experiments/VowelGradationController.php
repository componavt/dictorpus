...
class VowelGradationController extends Controller
{
    ...
    public function index() {
        return view('experiments/vowel_gradation/index');
    }
    
    public function nomGenPart($num) {
        if ($num==1) {
            $u='u';
            $a='a';
        } else {
        ...
        return view('experiments/vowel_gradation/nom_gen_part', compact('num', 'words'));
    }    
}
