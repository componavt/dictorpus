...
class DialectDmarkerController extends Controller
{
    ...
    public function frequencies()
    {
        ...
        return view(
            'experiments.dialect_dmarker.dialect_check',
    ...
    public function compareFreqSSindex()
    {
        ...
        return view(
            'experiments.dialect_dmarker.compare_freq_SSindex',
    ...
    public function checkResults()
    {
        ...
        foreach ([4, 5, 6] as $lang_id) {
            ...
            foreach ($dialects as $dialect) {
                ...
                $dataset[] = [
                    'dialect_name' => $dialect->name . ' (' . $total . ')',
        ...
        return view(
            'experiments.dialect_dmarker.check_results',
