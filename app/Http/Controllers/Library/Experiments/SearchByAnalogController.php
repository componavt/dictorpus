...
class SearchByAnalogController extends Controller
{
    ...
    public function resultsSearch(Request $request)
    {
        ...
        //        dd($results[0]);        
        return view(
            'experiments.search_by_analog.results_search_all',
...
*/
        return view(
            'experiments.search_by_analog.results_search',
    ...
    public function errorList(Request $request)
    {
        ...
        return view(
            'experiments.search_by_analog.error_list',
    ...
    public function checkWord(Request $request)
    {
        ...
        return view(
            'experiments.search_by_analog.check_word',
