...
class TextController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($error_message) {
            ...
            $redirect = $redirect->withSuccess(trans('messages.created_success'));
        }
        return $redirect;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($error_message) {
            ...
            return $redirect->withSuccess(trans('messages.updated_success'));
        }
    }
        ...
        if ($id != "" && $id > 0) {
            try {
                ...
                if ($text) {
                    ...
                    $text->remove();
                    $result['message'] = trans('corpus.text_removed', ['name' => $text_title]);
                } else {
                    $error = true;
