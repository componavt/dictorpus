...
*/
    ...
    public static function evaluateSearchGramsetByAllAffixes($wordform, $search_lang)
    {
        ...
        $list = self::searchGramsetByAffixes($wordform, $search_lang, $affix);
        if (!$list) {
...
*/
     ...
     * @param array $colors
     * @param array $color_names
     * @param int $duble_line_limit
     * @return array
     */
